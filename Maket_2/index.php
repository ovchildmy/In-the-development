	...
	<div class="headerWrap">
		<div class="header">
			<div class="container">
				...
				<div>
					<div>we <span>love</span> to write code</div>
					<div></div>
					<div class="header_content">
						Salem is a new and modern page Wordpress theme, designed and aimed at creative teams that want to showcase your products and services in a new and creative way
					</div>
					<div>
